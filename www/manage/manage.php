...
<script type="text/javascript" src="./js/manage_js.js"></script>
...
<div id="daddy">
	<div id="header">
		...
		<div id="menu">
			<ul>
				...
				<li><a id="active" href="./manage.php">Manage</a></li>
	...
	<div id="content">
		<div id="cA">
			...
			<span id="showBox"></span><!-- Infomation user -->
		...
		<div id="cB">
			...
			<div id="search">
                ...
                <input type="submit" class="submit" value="Adduser" OnClick="JavaScript:showBox('manage_information_add.php','')"/>
			</div><!-- search -->
