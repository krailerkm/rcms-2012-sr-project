...
<body Onload="JavaScript:fncAlertTime();LoadOnFC()">
...
<div id="daddy">
	<div id="header">
		...
		<div id="menu">
			<ul>
				<li><a id="active" href="./admin_page.php">Home</a></li>
				<li><a href="../device/onlineck.php">Device</a></li>
				<? if($_SESSION['Status']== "ADMIN") {?><li><a href="../manage/manage.php">Manage</a></li><? }//STATUS ADMIN ONLY SHOW  ?>
		...
		<div id="ticker">
			Wellcome user <a href="./admin_page.php"><?=$objResult["Name"];?></a> : <?=$_SESSION['Status']?>  status, or contact us about our programs, as well as feedback.
		</div><!-- ticker -->
		</div>
		...
		<div id="cA">
			...
			<h3 align="left">Information my user</h3>
            
			<div align="center">
            <table width="100" height="200" id="imgLoading">
            	<tr>
            ...
            </table></div><!-- DOWNLOAD BAR -->		
		
			<span id="showBox"></span><!-- showInfomationuser -->
		...
		<div id="cB">
			...
			<div align="center">
            <table width="100" height="200" id="imgLoadingTB">
            	<tr>
                	<td><img src="../images/loading.gif"></td>
                </tr>
				<tr>
			...
			<span id="showBoxUpdate"></span><!-- showupdatetb -->
		</div><!-- cB -->
